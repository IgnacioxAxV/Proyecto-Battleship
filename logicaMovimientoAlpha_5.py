...
def movimientoDestructores():
    ...
    for barco in barcosJ1.keys():
        if (barco in ["Destructor1J1", "Destructor2J1", "Destructor3J1", "Destructor4J1", "Destructor5J1", "Destructor6J1"]):
            ...
            elif (barcosJ1[barco]["disparos"]!=0):
                pass
        ...
        if (barco in ["Acorazado1J1", "Acorazado2J1"]):
            ...
            if (barcosJ1[barco]["vida"]==0):
                ...
                if (barcosJ1[barco]["y1"]==0):
                    ...
                    barcosJ1[barco]["y1"] = barcosJ1[barco]["y1"]+2
                    barcosJ1[barco]["y2"] = barcosJ1[barco]["y2"]
                    barcosJ1[barco]["y3"] = barcosJ1[barco]["y3"]-2
                elif (listaPosicionesBarcos.count((x1,y1-1))>=1):
                    if (barcosJ1[barco]["movimiento"]==0):
                        barcosJ1[barco]["orientacion"]= abajo
                        matrizJ1[y1][x1].configure(image= acorazadoHaciaAbajo3)
                    ...
                    barcosJ1[barco]["y1"] = barcosJ1[barco]["y1"]-1
                    barcosJ1[barco]["y2"] = barcosJ1[barco]["y2"]-1
                    barcosJ1[barco]["y3"] = barcosJ1[barco]["y3"]-1
                    barcosJ1[barco]["movimiento"] = 1
                ...
                if (barcosJ1[barco]["x1"]==0):
                    ...
                    barcosJ1[barco]["x1"] = barcosJ1[barco]["x1"]+2
                    barcosJ1[barco]["x2"] = barcosJ1[barco]["x2"]
                    barcosJ1[barco]["x3"] = barcosJ1[barco]["x3"]-2
                elif (listaPosicionesBarcos.count((x1-1,y1))>=1):
                    if (barcosJ1[barco]["movimiento"]==0):
                        barcosJ1[barco]["orientacion"]= derecha
                        matrizJ1[y1][x1].configure(image= acorazadoHaciaDerecha3)
                    ...
                    barcosJ1[barco]["x1"] = barcosJ1[barco]["x1"]-1
                    barcosJ1[barco]["x2"] = barcosJ1[barco]["x2"]-1
                    barcosJ1[barco]["x3"] = barcosJ1[barco]["x3"]-1
                    barcosJ1[barco]["movimiento"] = 1
